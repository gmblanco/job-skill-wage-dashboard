...
from src.charts_skills import top_skills_bar, skills_salary_correlation
...
def main():
    ...
    st.dataframe(df_corr.sort_values("Correlation", ascending=False).reset_index(drop=True))
